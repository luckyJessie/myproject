<template lang="pug">
  div(class="video_section" v-if="videoSrc")
    ...
    symbol(id="icon-fullscreen" viewBox="0 0 36 36")
      title fullscreen
      path(d="M10 21H7v8h8v-3h-5v-5zm-3-6h3v-5h5V7H7v8zm19 11h-5v3h8v-8h-3v5zM21 7v3h5v5h3V7h-8z")
    symbol(id="icon-unfullscreen" viewBox="0 0 36 36")
      title unfullscreen
      path(d="M7 24h5v5h3v-8H7v3zm5-12H7v3h8V7h-3v5zm9 17h3v-5h5v-3h-8v8zm3-17V7h-3v8h8v-3h-5z")
</template>
