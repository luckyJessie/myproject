...
<template lang="pug">
  div
    .uploadMymark
      label(for="upload2") 上传
      input(type="file" id='uploadMyMark2' ref='uploadMyMark2' style="position:absolute; clip:rect(0 0 0 0);" accept="image/png, image/jpeg, image/gif, image/jpg" @change="setImage")
      <!--div(id='uploadMyMark2' ref='uploadMyMark2' @click='setImage') 截屏-->
