...
<template lang="pug">
  div
    upload-dragger(:disabled=disabled v-on:file="showFile")
      label#uploadVideo(for="file") 选择视频上传
      input(type="file" ref="fileInput" name='file' id="file" :disabled='disable')
      p 或将视频拖拽到此处
</template>
<script>
  /*!
  ...
  import UploadDragger from './dragUpload'
